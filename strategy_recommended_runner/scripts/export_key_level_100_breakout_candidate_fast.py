...
from export_key_level_100_breakout_candidate import output_columns, print_ranked_preview, score_candidates
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="快速导出指定日期的利弗莫尔100关键点首次突破候选。")
...
def main() -> None:
    ...
    print("策略: 利弗莫尔100关键点首次突破；快速扫描本地 parquet；趋势=up")
