...
def stock_result_row(
    ...
    latest_close = float(df.iloc[-1]["close"])
    close_drawdown_pct = (current.top_price - latest_close) / current.top_price if current.top_price > 0 else float("nan")
    ...
    return {
        ...
        "close_drawdown_pct": close_drawdown_pct * 100,
...
def main() -> None:
    ...
    print(excel.to_string(
        ...
        formatters={
            ...
            "close_drawdown_pct": format_float,
